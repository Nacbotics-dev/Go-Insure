...
def demo() -> None:
    ...
    fund_account(
        default_app_address, 100_000 + 3200
    )  # TODO: can't figure out why I need the extra 3200
    print(
        f"""
    ...
    box_name = [
        int(box_name_hex[i : i + 2], 16) for i in range(0, len(box_name_hex), 2)
    ]
    ...
    default_app_client.call(
        ...
        pay_txn=TransactionWithSigner(txn=txn, signer=signer),
    )
